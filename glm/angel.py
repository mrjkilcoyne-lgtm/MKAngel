...
class Angel:
    ...
    def _seed_lexicon(self) -> None:
        ...
        seeds = [
            ...
            # ── Pronouns ─────────────────────────────────────
            ("I",          "pronoun", ["linguistic"],           "*eg-"),
            ("you",        "pronoun", ["linguistic"],           "*tu-"),
            ("he",         "pronoun", ["linguistic"],           "*ki-"),
            ("she",        "pronoun", ["linguistic"],           "*si-"),
            ("it",         "pronoun", ["linguistic"],           "*id-"),
            ("we",         "pronoun", ["linguistic"],           "*wei-"),
            ("they",       "pronoun", ["linguistic"],           "*to-"),
            ("me",         "pronoun", ["linguistic"],           "*me-"),
            ("my",         "pronoun", ["linguistic"],           "*mei-"),
            ("your",       "pronoun", ["linguistic"],           "*tu-"),
            ("this",       "pronoun", ["linguistic"],           "*to-"),
            ("that",       "pronoun", ["linguistic"],           "*to-"),
            ("what",       "pronoun", ["linguistic"],           "*kwo-"),
            ("who",        "pronoun", ["linguistic"],           "*kwo-"),
            ("which",      "pronoun", ["linguistic"],           "*kwo-"),
            ("where",      "pronoun", ["linguistic"],           "*kwo-"),
            ("when",       "pronoun", ["linguistic"],           "*kwo-"),
            ("how",        "pronoun", ["linguistic"],           "*kwo-"),
            ("why",        "pronoun", ["linguistic"],           "*kwo-"),
            # ── Determiners & articles ───────────────────────
            ("the",        "det",  ["linguistic"],             "*to-"),
            ("a",          "det",  ["linguistic"],             "*oi-"),
            ("an",         "det",  ["linguistic"],             "*oi-"),
            ("some",       "det",  ["linguistic"],             "*sem-"),
            ("any",        "det",  ["linguistic"],             "*oi-"),
            ("all",        "det",  ["linguistic"],             "*al-"),
            ("no",         "det",  ["linguistic"],             "*ne-"),
            ("every",      "det",  ["linguistic"],             "*aiw-"),
            # ── Prepositions ─────────────────────────────────
            ("in",         "prep", ["linguistic"],             "*en-"),
            ("on",         "prep", ["linguistic"],             "*an-"),
            ("at",         "prep", ["linguistic"],             "*ad-"),
            ("to",         "prep", ["linguistic"],             "*do-"),
            ("for",        "prep", ["linguistic"],             "*per-"),
            ("with",       "prep", ["linguistic"],             "*wi-"),
            ("from",       "prep", ["linguistic"],             "*per-"),
            ("by",         "prep", ["linguistic"],             "*bi-"),
            ("about",      "prep", ["linguistic"],             "*ambhi-"),
            ("into",       "prep", ["linguistic"],             "*en-"),
            ("through",    "prep", ["linguistic"],             "*ter-"),
            ("between",    "prep", ["linguistic"],             "*dwo-"),
            ("after",      "prep", ["linguistic"],             "*apo-"),
            ("before",     "prep", ["linguistic"],             "*per-"),
            ("over",       "prep", ["linguistic"],             "*uper-"),
            ("under",      "prep", ["linguistic"],             "*ndher-"),
            ("up",         "prep", ["linguistic"],             "*upo-"),
            ("down",       "prep", ["linguistic"],             "*dune-"),
            ("out",        "prep", ["linguistic"],             "*ud-"),
            # ── Conjunctions ─────────────────────────────────
            ("and",        "conj", ["linguistic"],             "*anti-"),
            ("but",        "conj", ["linguistic"],             "*be-ut-"),
            ("or",         "conj", ["linguistic"],             "*au-"),
            ("if",         "conj", ["linguistic"],             "*ei-"),
            ("because",    "conj", ["linguistic"],             "*kwod-"),
            ("so",         "conj", ["linguistic"],             "*swe-"),
            ("then",       "conj", ["linguistic"],             "*to-"),
            ("than",       "conj", ["linguistic"],             "*to-"),
            # ── Interjections ────────────────────────────────
            ("oh",         "intj", ["linguistic"],             "*o-"),
            ("ah",         "intj", ["linguistic"],             "*a-"),
            ("yes",        "intj", ["linguistic"],             "*ge-"),
            ("no",         "intj", ["linguistic"],             "*ne-"),
            ("hello",      "intj", ["linguistic"],             "*kel-"),
            ("hi",         "intj", ["linguistic"],             "*hei-"),
            ("hey",        "intj", ["linguistic"],             "*hei-"),
            ("well",       "intj", ["linguistic"],             "*wel-"),
            ("please",     "intj", ["linguistic"],             "*plak-"),
            ("thanks",     "intj", ["linguistic"],             "*tong-"),
            ("sorry",      "intj", ["linguistic"],             "*sair-"),
            ("wow",        "intj", ["linguistic"],             "*waw-"),
            ("hmm",        "intj", ["linguistic"],             "*hm-"),
            ("ok",         "intj", ["linguistic"],             "*ok-"),
            ("right",      "intj", ["linguistic"],             "*reg-"),
            ("sure",       "intj", ["linguistic"],             "*sekur-"),
            # ── Auxiliary / modal verbs ───────────────────────
            ("be",         "verb", ["linguistic"],             "*bhu-"),
            ("is",         "verb", ["linguistic"],             "*es-"),
            ("am",         "verb", ["linguistic"],             "*es-"),
            ("are",        "verb", ["linguistic"],             "*es-"),
            ("was",        "verb", ["linguistic"],             "*es-"),
            ("were",       "verb", ["linguistic"],             "*es-"),
            ("have",       "verb", ["linguistic"],             "*kap-"),
            ("has",        "verb", ["linguistic"],             "*kap-"),
            ("had",        "verb", ["linguistic"],             "*kap-"),
            ("do",         "verb", ["linguistic"],             "*dheh-"),
            ("does",       "verb", ["linguistic"],             "*dheh-"),
            ("did",        "verb", ["linguistic"],             "*dheh-"),
            ("will",       "verb", ["linguistic"],             "*wel-"),
            ("would",      "verb", ["linguistic"],             "*wel-"),
            ("can",        "verb", ["linguistic"],             "*gne-"),
            ("could",      "verb", ["linguistic"],             "*gne-"),
            ("should",     "verb", ["linguistic"],             "*skel-"),
            ("may",        "verb", ["linguistic"],             "*magh-"),
            ("might",      "verb", ["linguistic"],             "*magh-"),
            ("must",       "verb", ["linguistic"],             "*med-"),
            ("shall",      "verb", ["linguistic"],             "*skel-"),
            # ── Common verbs ─────────────────────────────────
            ("go",         "verb", ["linguistic"],             "*gheh-"),
            ("come",       "verb", ["linguistic"],             "*gwem-"),
            ("say",        "verb", ["linguistic"],             "*sekw-"),
            ("tell",       "verb", ["linguistic"],             "*del-"),
            ("ask",        "verb", ["linguistic"],             "*ais-"),
            ("use",        "verb", ["linguistic"],             "*oi-"),
            ("get",        "verb", ["linguistic"],             "*ghend-"),
            ("put",        "verb", ["linguistic"],             "*put-"),
            ("run",        "verb", ["linguistic"],             "*ren-"),
            ("move",       "verb", ["linguistic"],             "*mew-"),
            ("play",       "verb", ["linguistic"],             "*plegan-"),
            ("turn",       "verb", ["linguistic"],             "*kwel-"),
            ("keep",       "verb", ["linguistic"],             "*kap-"),
            ("hold",       "verb", ["linguistic"],             "*kel-"),
            ("let",        "verb", ["linguistic"],             "*leid-"),
            ("call",       "verb", ["linguistic"],             "*gal-"),
            ("look",       "verb", ["linguistic"],             "*log-"),
            ("show",       "verb", ["linguistic"],             "*skew-"),
            ("read",       "verb", ["linguistic"],             "*reh-"),
            ("write",      "verb", ["linguistic"],             "*wreid-"),
            ("live",       "verb", ["linguistic", "biological"], "*leip-"),
            ("die",        "verb", ["linguistic", "biological"], "*dhew-"),
            ("eat",        "verb", ["linguistic", "biological"], "*ed-"),
            ("drink",      "verb", ["linguistic"],             "*dhreg-"),
            ("walk",       "verb", ["linguistic"],             "*wel-"),
            ("sit",        "verb", ["linguistic"],             "*sed-"),
            ("stand",      "verb", ["linguistic"],             "*sta-"),
            ("wait",       "verb", ["linguistic"],             "*wag-"),
            ("stop",       "verb", ["linguistic"],             "*steb-"),
            ("start",      "verb", ["linguistic"],             "*ster-"),
            ("open",       "verb", ["linguistic"],             "*upo-"),
            ("close",      "verb", ["linguistic"],             "*klau-"),
            ("send",       "verb", ["linguistic"],             "*sent-"),
            ("bring",      "verb", ["linguistic"],             "*bhreng-"),
            ("leave",      "verb", ["linguistic"],             "*leip-"),
            ("stay",       "verb", ["linguistic"],             "*sta-"),
            ("fall",       "verb", ["linguistic", "physics"],  "*phol-"),
            ("rise",       "verb", ["linguistic"],             "*reg-"),
            ("break",      "verb", ["linguistic"],             "*bhreg-"),
            ("cut",        "verb", ["linguistic"],             "*sker-"),
            ("set",        "verb", ["linguistic"],             "*sed-"),
            # ── Common nouns ─────────────────────────────────
            ("thing",      "noun", ["linguistic"],             "*thenk-"),
            ("place",      "noun", ["linguistic"],             "*plat-"),
            ("way",        "noun", ["linguistic"],             "*wegh-"),
            ("day",        "noun", ["linguistic"],             "*dhegh-"),
            ("night",      "noun", ["linguistic"],             "*nekwt-"),
            ("year",       "noun", ["linguistic"],             "*yer-"),
            ("person",     "noun", ["linguistic"],             "*per-"),
            ("man",        "noun", ["linguistic"],             "*man-"),
            ("woman",      "noun", ["linguistic"],             "*gwen-"),
            ("child",      "noun", ["linguistic"],             "*kel-"),
            ("water",      "noun", ["linguistic", "chemical", "biological"], "*wed-"),
            ("fire",       "noun", ["linguistic", "chemical", "physics"],    "*paewr-"),
            ("earth",      "noun", ["linguistic"],             "*er-"),
            ("air",        "noun", ["linguistic", "physics"],  "*awer-"),
            ("hand",       "noun", ["linguistic"],             "*ghes-"),
            ("eye",        "noun", ["linguistic", "biological"], "*okw-"),
            ("head",       "noun", ["linguistic", "biological"], "*kaput-"),
            ("voice",      "noun", ["linguistic"],             "*wekw-"),
            ("sound",      "noun", ["linguistic", "physics"],  "*swen-"),
            ("colour",     "noun", ["linguistic", "physics"],  "*kel-"),
            ("sky",        "noun", ["linguistic"],             "*skew-"),
            ("sun",        "noun", ["linguistic", "physics"],  "*sawel-"),
            ("moon",       "noun", ["linguistic"],             "*meh-"),
            ("star",       "noun", ["linguistic", "physics"],  "*hster-"),
            ("door",       "noun", ["linguistic"],             "*dhwer-"),
            ("book",       "noun", ["linguistic"],             "*bhago-"),
            ("money",      "noun", ["linguistic"],             "*men-"),
            ("food",       "noun", ["linguistic", "biological"], "*pat-"),
            ("idea",       "noun", ["linguistic"],             "*weid-"),
            ("problem",    "noun", ["linguistic"],             "*pro-blem-"),
            ("answer",     "noun", ["linguistic"],             "*and-swar-"),
            ("question",   "noun", ["linguistic"],             "*kwes-"),
            # ── Common adjectives ────────────────────────────
            ("big",        "adj",  ["linguistic"],             "*bheg-"),
            ("small",      "adj",  ["linguistic"],             "*smel-"),
            ("long",       "adj",  ["linguistic"],             "*dlongho-"),
            ("short",      "adj",  ["linguistic"],             "*sker-"),
            ("high",       "adj",  ["linguistic"],             "*kouk-"),
            ("low",        "adj",  ["linguistic"],             "*legh-"),
            ("hot",        "adj",  ["linguistic", "physics"],  "*kai-"),
            ("cold",       "adj",  ["linguistic", "physics"],  "*gel-"),
            ("fast",       "adj",  ["linguistic"],             "*past-"),
            ("slow",       "adj",  ["linguistic"],             "*slew-"),
            ("hard",       "adj",  ["linguistic"],             "*kar-"),
            ("soft",       "adj",  ["linguistic"],             "*supo-"),
            ("dark",       "adj",  ["linguistic", "physics"],  "*dher-"),
            ("bright",     "adj",  ["linguistic", "physics"],  "*bhereg-"),
            ("full",       "adj",  ["linguistic"],             "*pleh-"),
            ("empty",      "adj",  ["linguistic"],             "*em-"),
            ("real",       "adj",  ["linguistic"],             "*reh-"),
            ("wrong",      "adj",  ["linguistic"],             "*wrang-"),
            ("same",       "adj",  ["linguistic"],             "*sem-"),
            ("different",  "adj",  ["linguistic"],             "*bher-"),
            # ── Adverbs ──────────────────────────────────────
            ("not",        "adv",  ["linguistic"],             "*ne-"),
            ("very",       "adv",  ["linguistic"],             "*wer-"),
            ("just",       "adv",  ["linguistic"],             "*yus-"),
            ("also",       "adv",  ["linguistic"],             "*al-"),
            ("still",      "adv",  ["linguistic"],             "*stel-"),
            ("only",       "adv",  ["linguistic"],             "*oi-"),
            ("even",       "adv",  ["linguistic"],             "*em-"),
            ("now",        "adv",  ["linguistic"],             "*nu-"),
            ("here",       "adv",  ["linguistic"],             "*ki-"),
            ("there",      "adv",  ["linguistic"],             "*to-"),
            ("always",     "adv",  ["linguistic"],             "*al-"),
            ("never",      "adv",  ["linguistic"],             "*ne-"),
            ("maybe",      "adv",  ["linguistic"],             "*magh-"),
            ("again",      "adv",  ["linguistic"],             "*gegn-"),
            ("too",        "adv",  ["linguistic"],             "*to-"),
            ("quite",      "adv",  ["linguistic"],             "*kwit-"),
            ("really",     "adv",  ["linguistic"],             "*reh-"),
            ("already",    "adv",  ["linguistic"],             "*al-"),
            ("together",   "adv",  ["linguistic"],             "*ghedh-"),
            ("away",       "adv",  ["linguistic"],             "*wegh-"),
            ("back",       "adv",  ["linguistic"],             "*bak-"),
            ("yet",        "adv",  ["linguistic"],             "*yet-"),
        ]
